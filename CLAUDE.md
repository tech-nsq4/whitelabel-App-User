...
- **ممنوع تضيف أي تعليقات كود (`//`, `///`) في أي كود بتكتبه أو تعدّله** — من غير استثناءات. لو الكود محتاج توضيح، اكتبه بشكل واضح من نفسه (تسمية متغيرات/دوال كويسة) بدل التعليق.
